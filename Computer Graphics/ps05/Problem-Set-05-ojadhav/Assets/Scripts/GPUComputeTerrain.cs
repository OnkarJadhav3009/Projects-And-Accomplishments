...
public class GPUComputeTerrain : MonoBehaviour
{
    ...
    void Awake(){
        ...
        mat = new Material(Shader.Find("MountainTerrainShader"));
        mr.material = mat;
    ...
    {   
        ...
        lightPos.position = RotationMatrix("y", 0.001f).MultiplyVector(lightPos.position);
    ...
    private Vector3[] getVertices()
    {
        ...
        for (int i = 0; i < resX; i++)
            for (int j = 0; j < resY; j++){
                ...
                vertices.Add(new Vector3(i, y, -j));
            }
